...
write.csv(as.data.frame(pred_dnn),"D:/77/Reasearch/temp/dnn_pred_sat.csv",row.names = FALSE)
write.csv(as.data.frame(pred_dk),"D:/77/Reasearch/temp/dk_pred_sat.csv",row.names = FALSE)
write.csv(as.data.frame(pred_ck),"D:/77/Reasearch/temp/ck_pred_sat.csv",row.names = FALSE)
write.csv(as.data.frame(pred_inla),"D:/77/Reasearch/temp/inla_pred_sat.csv",row.names = FALSE)
