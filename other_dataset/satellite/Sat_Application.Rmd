...
model_dnn %>% compile(
  ...
  filepath = "D:/77/research/temp/sat_best_weights_dnn.h5",
  save_best_only = TRUE,
  monitor = "val_loss",
  mode = "min",
  verbose = 1
...
model_dnn %>% load_model_weights_hdf5("D:/77/research/temp/sat_best_weights_dnn.h5")
...
model_dk %>% compile(
  ...
  model_checkpoint <- callback_model_checkpoint(
  filepath = "D:/77/research/temp/sat_best_weights_dk.h5",
  save_best_only = TRUE,
  monitor = "val_loss",
  mode = "min",
  verbose = 1
...
model_dk %>% load_model_weights_hdf5("D:/77/research/temp/sat_best_weights_dk.h5")
...
```{r}
rm(basis_1, basis_1_g, basis_2, basis_2_g, basis_3, basis_3_g, basis_use_1_2d, basis_use_1_2d_g, basis_use_2_2d, basis_use_2_2d_g, basis_use_3_2d, basis_use_3_2d_g)
...
model_ck %>% compile(
 ...
 model_checkpoint <- callback_model_checkpoint(
  filepath = "D:/77/research/temp/sat_best_weights_ck.h5",
  save_best_only = TRUE,
  monitor = "val_loss",
  mode = "min",
  verbose = 0
...
model_ck %>% load_model_weights_hdf5("D:/77/research/temp/sat_best_weights_ck.h5")
...
write.csv(crps_dnn_all,"D:/77/Research/temp/sat_pred/crps_dnn_sat.csv",row.names = FALSE)
write.csv(crps_dk_all,"D:/77/Research/temp/sat_pred/crps_dk_sat.csv",row.names = FALSE)
write.csv(crps_ck_all,"D:/77/Research/temp/sat_pred/crps_ck_sat.csv",row.names = FALSE)
write.csv(crps_inla_all,"D:/77/Research/temp/sat_pred/crps_inla_sat.csv",row.names = FALSE)
...
write.csv(int_score_dnn,"D:/77/Research/temp/sat_pred/int_dnn_sat.csv",row.names = FALSE)
write.csv(int_score_dk,"D:/77/Research/temp/sat_pred/int_dk_sat.csv",row.names = FALSE)
write.csv(int_score_ck,"D:/77/Research/temp/sat_pred/int_ck_sat.csv",row.names = FALSE)
write.csv(int_score_inla,"D:/77/Research/temp/sat_pred/int_inla_sat.csv",row.names = FALSE)
