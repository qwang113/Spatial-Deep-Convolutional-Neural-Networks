...
write.csv(as.data.frame(pred_dnn_g),"D:/77/Reasearch/temp/sat_pred/dnn_pred_sat_g.csv",row.names = FALSE)
write.csv(as.data.frame(pred_dk_g),"D:/77/Reasearch/temp/sat_pred/dk_pred_sat_g.csv",row.names = FALSE)
write.csv(as.data.frame(pred_ck_g),"D:/77/Reasearch/temp/sat_pred/ck_pred_sat_g.csv",row.names = FALSE)
write.csv(as.data.frame(pred_inla_g),"D:/77/Reasearch/temp/sat_pred/inla_pred_sat_g.csv",row.names = FALSE)
