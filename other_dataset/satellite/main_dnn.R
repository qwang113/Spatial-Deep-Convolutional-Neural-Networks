...
write.csv(as.data.frame(pred_dnn),"D:/77/Research/temp/sat_pred/dnn_pred_sat.csv",row.names = FALSE)
write.csv(as.data.frame(pred_dnn_g),"D:/77/Research/temp/sat_pred/dnn_pred_sat_g.csv",row.names = FALSE)