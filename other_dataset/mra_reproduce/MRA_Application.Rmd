...
for (curr_index in 1:num_fold) {
  print(paste("Now doint index: ", curr_index))
...
write.csv(as.data.frame(pred_dnn),"D:/77/Reasearch/temp/dnn_pred_mra.csv",row.names = FALSE)
write.csv(as.data.frame(pred_dk),"D:/77/Reasearch/temp/dk_pred_mra.csv",row.names = FALSE)
write.csv(as.data.frame(pred_ck),"D:/77/Reasearch/temp/ck_pred_mra.csv",row.names = FALSE)
write.csv(as.data.frame(pred_inla),"D:/77/Reasearch/temp/inla_pred_mra.csv",row.names = FALSE)
...
pred_dnn <- as.matrix(read.csv("D:/77/Reasearch/temp/dnn_pred_mra.csv"))
pred_dk <- as.matrix(read.csv("D:/77/Reasearch/temp/dk_pred_mra.csv"))
pred_ck <- as.matrix(read.csv("D:/77/Reasearch/temp/ck_pred_mra.csv"))
pred_inla <- as.matrix(read.csv("D:/77/Reasearch/temp/inla_pred_mra.csv"))
