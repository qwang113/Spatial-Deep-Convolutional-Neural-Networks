...
pred_dnn <- as.matrix(read.csv("D:/77/Reasearch/temp/dnn_pred.csv"))
pred_dk <- as.matrix(read.csv("D:/77/Reasearch/temp/dk_pred.csv"))
pred_ck <- as.matrix(read.csv("D:/77/Reasearch/temp/ck_pred.csv"))
pred_inla <- as.matrix(read.csv("D:/77/Reasearch/temp/inla_pred.csv"))
