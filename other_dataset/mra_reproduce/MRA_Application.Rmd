...
write.csv(as.data.frame(loss_all),here::here("other_dataset/mra_reproduce/mra_loss.csv"),row.names = FALSE)
loss_all <- read.csv(here::here("other_dataset/mra_reproduce/mra_loss.csv"))



write.csv(as.data.frame(pred_dnn),"D:/77/Reasearch/temp/mra_pred/dnn_pred_mra.csv",row.names = FALSE)
write.csv(as.data.frame(pred_dk),"D:/77/Reasearch/temp/mra_pred/dk_pred_mra.csv",row.names = FALSE)
write.csv(as.data.frame(pred_ck),"D:/77/Reasearch/temp/mra_pred/ck_pred_mra.csv",row.names = FALSE)
write.csv(as.data.frame(pred_inla),"D:/77/Reasearch/temp/mra_pred/inla_pred_mra.csv",row.names = FALSE)

# 
# write.csv(as.data.frame(pred_dnn_g),"D:/77/Reasearch/temp/mra_pred/dnn_pred_mra_g.csv",row.names = FALSE)
# write.csv(as.data.frame(pred_dk_g),"D:/77/Reasearch/temp/mra_pred/dk_pred_mra_g.csv",row.names = FALSE)
# write.csv(as.data.frame(pred_ck_g),"D:/77/Reasearch/temp/mra_pred/ck_pred_mra_g.csv",row.names = FALSE)
# write.csv(as.data.frame(pred_inla_g),"D:/77/Reasearch/temp/mra_pred/inla_pred_mra_g.csv",row.names = FALSE)
...
write.csv(crps_dnn_all,"D:/77/Reasearch/temp/mra_pred/crps_dnn_mra.csv",row.names = FALSE)
write.csv(crps_dk_all,"D:/77/Reasearch/temp/mra_pred/crps_dk_mra.csv",row.names = FALSE)
write.csv(crps_ck_all,"D:/77/Reasearch/temp/mra_pred/crps_ck_mra.csv",row.names = FALSE)
write.csv(crps_inla_all,"D:/77/Reasearch/temp/mra_pred/crps_inla_mra.csv",row.names = FALSE)

crps_dnn_all <- as.matrix(read.csv("D:/77/Reasearch/temp/mra_pred/crps_dnn_mra.csv"))
crps_dk_all <- as.matrix(read.csv("D:/77/Reasearch/temp/mra_pred/crps_dk_mra.csv"))
crps_ck_all <- as.matrix(read.csv("D:/77/Reasearch/temp/mra_pred/crps_ck_mra.csv"))
crps_inla_all <- as.matrix(read.csv("D:/77/Reasearch/temp/mra_pred/crps_inla_mra.csv"))
...
write.csv(int_score_dnn,"D:/77/Reasearch/temp/mra_pred/int_dnn_mra.csv",row.names = FALSE)
write.csv(int_score_dk,"D:/77/Reasearch/temp/mra_pred/int_dk_mra.csv",row.names = FALSE)
write.csv(int_score_ck,"D:/77/Reasearch/temp/mra_pred/int_ck_mra.csv",row.names = FALSE)
write.csv(int_score_inla,"D:/77/Reasearch/temp/mra_pred/int_inla_mra.csv",row.names = FALSE)
