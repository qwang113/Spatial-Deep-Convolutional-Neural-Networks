...
loss_dnn[curr_index] <- evaluate(model_dnn, x_te, y_te)[2]
 pb <- txtProgressBar(min = 0,      # Minimum value of the progress bar
                     max = num_sample, # Maximum value of the progress bar
...
# write.csv(as.data.frame(pred_dnn),here::here("other_dataset/mra_reproduce/dnn_pred.csv"),row.names = FALSE)
# write.csv(as.data.frame(pred_dk),here::here("other_dataset/mra_reproduce/dk_pred.csv"),row.names = FALSE)
# write.csv(as.data.frame(pred_ck),here::here("other_dataset/mra_reproduce/ck_pred.csv"),row.names = FALSE)
# write.csv(as.data.frame(pred_inla),here::here("other_dataset/mra_reproduce/inla_pred.csv"),row.names = FALSE)
...
pred_dnn <- as.matrix(read.csv(here::here("D:/77/Reasearch/temp/dnn_pred_mra.csv")))
pred_dk <- as.matrix(read.csv(here::here("D:/77/Reasearch/temp/dk_pred_mra.csv")))
pred_ck <- as.matrix(read.csv(here::here("D:/77/Reasearch/temp/ck_pred_mra.csv")))
pred_inla <- as.matrix(read.csv(here::here("D:/77/Reasearch/temp/inla_pred_mra.csv")))
