rm(list = ls())
setwd(here::here("other_dataset/mra_reproduce"))
source(here::here("other_dataset/mra_reproduce/MRAfunctions.R"))
...
data=as.data.frame(read.csv(here::here("other_dataset/mra_reproduce/MIRSmra.csv"),header=FALSE))
...
ggplot() + theme_bw() + 
  ...
  geom_point(data=data,aes(x=longitude,y=latitude,colour=observations),size=1.5,shape=16) + 
