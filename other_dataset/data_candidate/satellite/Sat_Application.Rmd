...
load(here::here("other_dataset/data_candidate/satellite/SatelliteTemps.RData"))
...
ggplot() +
  geom_boxplot(data = reshape2::melt(loss_all), aes(x = variable, y = value)) +
   coord_flip()
write.csv(as.data.frame(loss_all),here::here("other_dataset/data_candidate/satellite/sat_loss.csv"),row.names = FALSE)
loss_all <- read.csv(here::here("other_dataset/data_candidate/satellite/sat_loss.csv"))
