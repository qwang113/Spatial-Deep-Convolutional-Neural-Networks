...
```{r}
# The data set is from: https://data.cityofchicago.org/Public-Safety/Crimes-2001-to-Present/ijzp-q8t2
...
write.csv(as.data.frame(loss_all),here::here("other_dataset/chicago_crime/loss_chi.csv"),row.names = FALSE)
loss_all <- read.csv(here::here("other_dataset/chicago_crime/loss_chi.csv"))
