...
mod_train_dk <- model_dk %>%
  fit(x = x_tr, y = y_tr, epochs =1000, batch_size = 200, 
...
write.csv(as.data.frame(pred_dnn),"D:/77/Research/temp/dnn_pred_soc.csv",row.names = FALSE)
write.csv(as.data.frame(pred_dk),"D:/77/Research/temp/dk_pred_soc.csv",row.names = FALSE)
write.csv(as.data.frame(pred_ck),"D:/77/Research/temp/ck_pred_soc.csv",row.names = FALSE)
write.csv(as.data.frame(pred_inla),"D:/77/Research/temp/inla_pred_soc.csv",row.names = FALSE)
