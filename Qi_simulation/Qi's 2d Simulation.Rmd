...
write.csv(as.data.frame(loss_all),here::here("other_dataset/ehellite/eh_loss.csv"),row.names = FALSE)
loss_all <- read.csv(here::here("other_dataset/ehellite/eh_loss.csv"))
...
write.csv(as.data.frame(pred_dnn),here::here("other_dataset/ehellite/dnn_pred.csv"),row.names = FALSE)
write.csv(as.data.frame(pred_dk),here::here("other_dataset/ehellite/dk_pred.csv"),row.names = FALSE)
write.csv(as.data.frame(pred_ck),here::here("other_dataset/ehellite/ck_pred.csv"),row.names = FALSE)
write.csv(as.data.frame(pred_inla),here::here("other_dataset/ehellite/inla_pred.csv"),row.names = FALSE)
...
library(sp)
library(ggplot2)
load(here::here("other_dataset/ehellite/ehelliteTemps.RData"))
eh_raw <- na.omit(eh.temps)
colnames(eh_raw) <- c("long","lat","y")


eh_dat <- aggregate(y ~ long + lat, data = eh_raw, FUN = mean)
