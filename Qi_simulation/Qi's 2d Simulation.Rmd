...
#source(here::here("other_dataset/ehellite/scoringRules_wrappers.R"))
...
ggplot(data = reshape2::melt(as.data.frame(cbind(crps_dnn_all,crps_dk_all,crps_ck_all,crps_inla_all))), aes(x = variable, y = -value, fill = variable)) +
  geom_boxplot() +
...
ggplot() +
  ...
  scale_fill_viridis() +
  geom_line(aes(x = c(60,80),y = c(0,0)), color = "red", linewidth = 0.5, linetype = "dashed") +
  geom_line(aes(x = c(60,80),y = c(50,50)), color = "red", linewidth = 0.5, linetype = "dashed") +
  geom_line(aes(x = c(60,60),y = c(0,50)), color = "red", linewidth = 0.5, linetype = "dashed") +
  geom_line(aes(x = c(80,80),y = c(0,50)), color = "red", linewidth = 0.5, linetype = "dashed") 
