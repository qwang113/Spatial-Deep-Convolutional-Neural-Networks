...
mod_train_dk <- model_dk %>%
  fit(x = x_tr, y = y_tr, epochs =500, batch_size = 2000, 
...
pred_dnn <- as.matrix(read.csv("D:/77/Research/temp/dnn_pred_eh.csv"))
pred_dk <- as.matrix(read.csv("D:/77/Research/temp/dk_pred_eh.csv"))
pred_ck <- as.matrix(read.csv("D:/77/Research/temp/ck_pred_eh.csv"))
pred_inla <- as.matrix(read.csv("D:/77/Research/temp/inla_pred_eh.csv"))
...
write.csv(crps_dnn_all,"D:/77/Research/temp/crps_dnn_eh.csv",row.names = FALSE)
write.csv(crps_dk_all,"D:/77/Research/temp/crps_dk_eh.csv",row.names = FALSE)
write.csv(crps_ck_all,"D:/77/Research/temp/crps_ck_eh.csv",row.names = FALSE)
write.csv(crps_inla_all,"D:/77/Research/temp/crps_inla_eh.csv",row.names = FALSE)

crps_dnn_all <- as.matrix(read.csv("D:/77/Research/temp/crps_dnn_eh.csv"))
crps_dk_all <- as.matrix(read.csv("D:/77/Research/temp/crps_dk_eh.csv"))
crps_ck_all <- as.matrix(read.csv("D:/77/Research/temp/crps_ck_eh.csv"))
crps_inla_all <- as.matrix(read.csv("D:/77/Research/temp/crps_inla_eh.csv"))
