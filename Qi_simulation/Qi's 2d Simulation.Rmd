...
cowplot::plot_grid(p_obs, p_dk, p_ck, nrow = 1)
```


```{r}
# Install the googleLanguageR package
...
my_text <- "Hello, this is R speaking!"

# Generate speech using the Google Text-to-Speech API
tts <- googleLanguageR::tts(text = my_text, voice = "en-US-Wavenet-D")

# Save the audio to a file
writeBin(tts$content, "my_speech.wav")

# Play the audio
tuneR::play("my_speech.wav")
