...
show_idx <- 15
ggplot() +
  geom_path(aes(x = seq(from = 0, to = 1, length.out = 200), y = krig_grid_pred[show_idx,], color = "Exp Kriging")) +
  geom_path(aes(x = seq(from = 0, to = 1, length.out = 200), y = nn_grid_pred[show_idx,], color = "DNN")) +
  geom_path(aes(x = seq(from = 0, to = 1, length.out = 200), y = dkrig_grid_pred[show_idx,], color = "Deep Kriging"))+ 
  geom_path(aes(x = seq(from = 0, to = 1, length.out = 200), y = mkrig_grid_pred[show_idx,], color = "Matern Kriging"))+ 
